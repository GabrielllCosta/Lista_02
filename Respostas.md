...
Justificativa: O update() é uma função/método do Phaser que serve para atualizar frame por frame da ilustração gráfica, então para realizar isso ele roda em loop.
______
...
```
Valor:"Digete valor do produto"
Ler valor
SE valor < 50 Então
    Escrever "Frete não disponível!"
Caso se valor <=199,99 e valor > 50 Então
    Escrever "Frete com custo adicional!"
Caso se valor>=200 Então
